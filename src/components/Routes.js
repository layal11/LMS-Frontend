...
//       <Sidebar  />
//        <Switch>
//            <Route path="/section/:sectionId" component={NewSection} />
//            <Route path="/newSection" component={NewSection}  />
//            <Route path="/listSection" component={SectionList}  />
//
//            <Route path="/classes/:classid" component={NewClass}  />
//            <Route path="/newClass" component={NewClass}  />
//            <Route path="/listClass" component={ClassList}  />
//
//            <Route path="/admin/:adminId" component={Admin}  />
...
//            <Route path="/DeleteTest"  component={DeleteTest}  />
//            <Route path="/CreateAdmins" component={CreateAdmins} />
